...
const PROGRAMME_LOGIC: Record<string, CourseData> = {
  business: {
    slides: {
      small_audience: ["VIDEO: How to make your devices work for you", "AUDIO: Free yourself, write index cards", "VIDEO: 4 Friends: Voice, posture, gestures, eye contact", "AUDIO: Establish contact with the audience", "AUDIO: the day before: general rehearsal", "VIDEO: Relax: the big day!", "AUDIO: Congratulations and reflection"],
      large_audience: ["VIDEO: How to make your devices work for you", "AUDIO: Free yourself, write index cards", "VIDEO: 4 Friends: Voice, posture, gestures, eye contact", "AUDIO: Establish contact with the audience", "AUDIO: the day before: general rehearsal", "VIDEO: Relax: the big day!", "AUDIO: Congratulations and reflection", "VIDEO: large venue, many people - how to handle"]
    },
    no_slides: {
      small_audience: ["AUDIO: Free yourself, write index cards", "VIDEO: 4 Friends: Voice, posture, gestures, eye contact", "AUDIO: Establish contact with the audience", "AUDIO: the day before: general rehearsal", "VIDEO: Relax: the big day!", "AUDIO: Congratulations and reflection"],
      large_audience: ["AUDIO: Free yourself, write index cards", "VIDEO: 4 Friends: Voice, posture, gestures, eye contact", "AUDIO: Establish contact with the audience", "AUDIO: the day before: general rehearsal", "VIDEO: Relax: the big day!", "AUDIO: Congratulations and reflection", "VIDEO: large venue, many people - how to handle"]
    }
  },
  ceremonial: {
    slides: {
      small_audience: ["VIDEO: How to make your devices work for you", "VIDEO: Once upon a time … Storytelling (basic)", "AUDIO: presenting poems and literature (basic)", "VIDEO: use this secreat weapon: change of posture", "VIDEO: 4 Friends: Voice, posture, gestures, eye contact", "AUDIO: Establish contact with the audience", "AUDIO: the day before: general rehearsal", "VIDEO: Relax: the big day!", "AUDIO: Congratulations and reflection"],
      large_audience: ["VIDEO: How to make your devices work for you", "VIDEO: Once upon a time … Storytelling (basic)", "AUDIO: presenting poems and literature (basic)", "VIDEO: use this secreat weapon: change of posture", "VIDEO: 4 Friends: Voice, posture, gestures, eye contact", "AUDIO: Establish contact with the audience", "AUDIO: the day before: general rehearsal", "VIDEO: Relax: the big day!", "AUDIO: Congratulations and reflection", "VIDEO: large venue, many people - how to handle"]
    },
    no_slides: {
      small_audience: ["VIDEO: Once upon a time … Storytelling (basic)", "AUDIO: presenting poems and literature (basic)", "VIDEO: use this secreat weapon: change of posture", "VIDEO: 4 Friends: Voice, posture, gestures, eye contact", "AUDIO: Establish contact with the audience", "AUDIO: the day before: general rehearsal", "VIDEO: Relax: the big day!", "AUDIO: Congratulations and reflection"],
      large_audience: ["VIDEO: Once upon a time … Storytelling (basic)", "AUDIO: presenting poems and literature (basic)", "VIDEO: use this secreat weapon: change of posture", "VIDEO: 4 Friends: Voice, posture, gestures, eye contact", "AUDIO: Establish contact with the audience", "AUDIO: the day before: general rehearsal", "VIDEO: Relax: the big day!", "AUDIO: Congratulations and reflection", "VIDEO: large venue, many people - how to handle"]
    }
  },
  political: {
    slides: {
      small_audience: ["VIDEO: How to make your devices work for you", "VIDEO: Once upon a time … Storytelling (basic)", "VIDEO: use this secreat weapon: change of posture", "AUDIO: Create emotions, make an appeal", "VIDEO: 4 Friends: Voice, posture, gestures, eye contact", "AUDIO: Establish contact with the audience", "AUDIO: the day before: general rehearsal", "VIDEO: Relax: the big day!", "AUDIO: Congratulations and reflection"],
      large_audience: ["VIDEO: How to make your devices work for you", "VIDEO: Once upon a time … Storytelling (basic)", "VIDEO: use this secreat weapon: change of posture", "AUDIO: Create emotions, make an appeal", "VIDEO: 4 Friends: Voice, posture, gestures, eye contact", "AUDIO: Establish contact with the audience", "AUDIO: the day before: general rehearsal", "VIDEO: Relax: the big day!", "AUDIO: Congratulations and reflection", "VIDEO: large venue, many people - how to handle"]
    },
    no_slides: {
      small_audience: ["VIDEO: Once upon a time … Storytelling (basic)", "VIDEO: use this secreat weapon: change of posture", "AUDIO: Create emotions, make an appeal", "VIDEO: 4 Friends: Voice, posture, gestures, eye contact", "AUDIO: Establish contact with the audience", "AUDIO: the day before: general rehearsal", "VIDEO: Relax: the big day!", "AUDIO: Congratulations and reflection"],
      large_audience: ["VIDEO: Once upon a time … Storytelling (basic)", "VIDEO: use this secreat weapon: change of posture", "AUDIO: Create emotions, make an appeal", "VIDEO: 4 Friends: Voice, posture, gestures, eye contact", "AUDIO: Establish contact with the audience", "AUDIO: the day before: general rehearsal", "VIDEO: Relax: the big day!", "AUDIO: Congratulations and reflection", "VIDEO: large venue, many people - how to handle"]
  ...
  teaching: {
    slides: {
      small_audience: ["VIDEO: How to make your devices work for you", "VIDEO: Once upon a time … Storytelling (basic)", "AUDIO: presenting poems and literature (basic)", "VIDEO: use this secreat weapon: change of posture", "VIDEO: 4 Friends: Voice, posture, gestures, eye contact", "AUDIO: Establish contact with the audience", "AUDIO: the day before: general rehearsal", "AUDIO: Create emotions, make an appeal"],
      large_audience: ["VIDEO: How to make your devices work for you", "VIDEO: Once upon a time … Storytelling (basic)", "AUDIO: presenting poems and literature (basic)", "VIDEO: use this secreat weapon: change of posture", "VIDEO: 4 Friends: Voice, posture, gestures, eye contact", "AUDIO: Establish contact with the audience", "AUDIO: the day before: general rehearsal", "AUDIO: Create emotions, make an appeal", "VIDEO: large venue, many people - how to handle"]
    },
    no_slides: {
      small_audience: ["VIDEO: Once upon a time … Storytelling (basic)", "AUDIO: presenting poems and literature (basic)", "VIDEO: use this secreat weapon: change of posture", "VIDEO: 4 Friends: Voice, posture, gestures, eye contact", "AUDIO: Establish contact with the audience", "AUDIO: the day before: general rehearsal", "AUDIO: Create emotions, make an appeal"],
      large_audience: ["VIDEO: Once upon a time … Storytelling (basic)", "AUDIO: presenting poems and literature (basic)", "VIDEO: use this secreat weapon: change of posture", "VIDEO: 4 Friends: Voice, posture, gestures, eye contact", "AUDIO: Establish contact with the audience", "AUDIO: the day before: general rehearsal", "AUDIO: Create emotions, make an appeal", "VIDEO: large venue, many people - how to handle"]
...
function getAudienceSizeCategory(sizeStr: string): 'small_audience' | 'large_audience' {
...
function createCourseItem(item: string): HTMLDivElement {
...
function renderProgrammePage() {
  ...
  const hasSlides = hasScreenAnswer.includes('yes') || hasScreenAnswer.includes('y') || hasScreenAnswer === 'true';
  ...
  const sizeLabel = audienceSize === 'large_audience' ? 'Large Audience (100+)' : 'Small Audience (<100)';
...
async function submitToServer() {
  ...
  try {
    ...
    addMessage("Here is your customized programme! Please go to the Your Programme tab below to view your personalized course content.", false);
    ...
    viewProgramBtn.onclick = () => {
      const programmeTab = document.querySelector('[data-page="page-programme"]') as HTMLButtonElement;
      if (programmeTab) {
